...
Data are _the_ information you want to display.
...
Aesthetics are maps from the (variables into the) data to the 
...
Geoms are the graphical objects used in the plot to draw the information
in your data in the way described by the aesthetics.

```{r base-geom}
quiz(caption = "Geom-quiz",
  question("Can you use more than one `geom_*()` drowing a plot?",
...
Feel free to explore your own code and solutions here playing with 
