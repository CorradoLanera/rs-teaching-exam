...
```{r, echo = FALSE}
countdown(minutes = 2, warn_when = 10, play_sound = TRUE,
          left = "34%", bottom = "50%")
```
...
To start thinking about the text into plots, I would like you to answer a quick question: In plots, what textual elements have driven you mad? 
For what you are here, which are some examples you have encounter?
...
"Now I will put you in a break-out room, you have two minutes to present 
each other and to create a list of examples for types of text you can 
encounter in a plot. Ready: go."
...
Now, for the last four minutes, I have prepared a short interactive tutorial for you, covering all the aspect we explored today step-by-step. Please, by group, go to the website (I put the link in the chat if you have not access to the slide), discuss and answer to all the topic you like (order is not mandatory). The only exception is the last one, that I ask you NOT to select. Please, thumb up when you are ready.
...
Well, here I have put for you the main resources I have used to produce the current lesson, including the link to the source code producing all the presented materials. Please note, pressing "P" on the slides will show the presenter mode, including my transcription for this lesson for your convenience.
...
One last thing, the last section of the tutorial will serve you to test all your new skills in drawing text with `ggplot2`. It will guide you to produce a complete customized plot like the one we have produced here, and giving you a free space to explore your own code, while providing some ready-to-use chunks of code. It will be there for you in the future.

Also, I have put a last section in the google docs I have sent you. Please, feel that if you like to drop feedbacks. I will really appreciate that.


With this I have conclude my lesson, thank you again, and if there are no further question: have a lovely night. 
