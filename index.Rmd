...
# Step-by-Step guesses and exploration

Please, open [**THIS**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) interactive tutorial.


You will be asked to explore it one stage at time.
...
You have an entire whole minute for each stage. 

Are you ready? Let's start with the first two!
<br><br><br><br>

???

At the end, go to the live code (ap to aesthetics included)
...
Return to the [**TUTORIAL**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) for the third stage about `geom_*()`s!
...
At the end, go to the live code
...
Return to the [**TUTORIAL**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) for the fourth stage about `annotate()`!
...
Return to the [**TUTORIAL**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) for the fifth stage about `scale_<AES>_<TYPE>()`s, legends, and `labs()`!
...
Return to the [**TUTORIAL**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) for the sixth stage about `facet_*()`s!
...
Return to the [**TUTORIAL**](https://corradolanera.shinyapps.io/text-gg-checks/#section-step-by-step-checks) for the seventh stage about `theme()`s!

(You have reached the last one: you have gain a double-time gift)
