...
Now you can test all your new skills in drawing text with `ggplot2`. The quiz I purpose you has a first review section for every step we performed, giving you also space to try your own code live. At the end you will be guided to produce a complete customized plot like the one we have produced here.
...
To conclude, here I have put for you the main resources used to produce the current lesson, including the link to the source code of all the materials.
