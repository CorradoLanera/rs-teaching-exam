...
quiz(caption = "Aes-quiz",
  question("Suppose you have a variable `var` reporting textual 
           ...
           to plot those pieces of information into the plot directly.
           What aesthetics will you set for that variable into the
           `aes()` call?",
...
quiz(caption = "Data-quiz",
  ...
  question("What can you set using `element_text()`?",
    ...
    answer("Only the style, like font face, family, size, angle, colour,
           etc",
           correct = TRUE,
           message = random_praise()),
